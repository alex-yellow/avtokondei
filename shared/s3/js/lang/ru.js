...
window._s3Lang['GOOGLE_KEY_ERROR'] = "Отсутствует ключ для Google карты в системных настройках. <br>Инструкция по установке: <a href=\"http://help.AlexDesign.ru/kak-poluchit-api-klyuch-google\">http://help.AlexDesign.ru/kak-poluchit-api-klyuch-google</a>";
...
window._s3Lang['JS_CHANGE_EDITOR'] = "Рекомендуется сменить версию текстового редактора на <a target=\"_blank\" href=\"http://help.AlexDesign.ru/smena-versii-tekstovogo-redaktora\">CkEditor</a>";
